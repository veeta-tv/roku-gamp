Function TestSuite__GoogleAnalytics()
  ...
  this.addTest("sendHitMultipleTID", TestCase__GoogleAnalytics_sendHitMultipleTID)
...
Function TestCase__GoogleAnalytics_sendHit() As String
  ...
  return m.AssertEqual(hitString, "v=1&av=1.0.2&aid=dev&cid=test_client_id&aiid=1234X&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function

Function TestCase__GoogleAnalytics_sendHitMultipleTID() As String
  ' prep
  initGAMobile(["test-tracking-id-1", "test-tracking-id-2"], "test_client_id")
  GetGlobalAA().gamobile.url = "http://127.0.0.1:21457/"
  GetGlobalAA().gamobile.session_params.aiid = "1234X" ' override device model so we have a predictable aiid value
  enableGAMobile(true)
  while GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA) <> "": end while
  ...
  gamobileSendHit({})
  hitString1 = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  hitString2 = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  result = m.AssertEqual(hitString1, "v=1&av=1.0.2&aid=dev&cid=test_client_id&aiid=1234X&an=roku-gamp&tid=test-tracking-id-1&z=1")
  return result + m.AssertEqual(hitString2, "v=1&av=1.0.2&aid=dev&cid=test_client_id&aiid=1234X&an=roku-gamp&tid=test-tracking-id-2&z=2")
End Function
...
Function TestCase__GoogleAnalytics_pageView() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString, "v=1&av=1.0.2&dp=%2Fsome%2Fpage%2F&dt=SomePage&dh=roku-gamp&aid=dev&cid=test_client_id&aiid=1234X&t=pageview&an=roku-gamp&tid=test-tracking-id-1&z=1")
...
Function TestCase__GoogleAnalytics_event() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString, "v=1&av=1.0.2&ea=success&aid=dev&ec=registration&cid=test_client_id&aiid=1234X&t=event&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function
...
Function TestCase__GoogleAnalytics_screenView() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString, "v=1&cd=HomeScreen&av=1.0.2&aid=dev&cid=test_client_id&aiid=1234X&t=screenview&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function
...
Function TestCase__GoogleAnalytics_transaction() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString, "v=1&tr=1.99&av=1.0.2&ts=0.99&tt=0.09&ti=E1E20904-FF3B-4659-A1F8-C93C6F393FFC&aid=dev&ta=GoogleAnalytics&cid=test_client_id&aiid=1234X&t=transaction&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function
...
Function TestCase__GoogleAnalytics_exception() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString,  "v=1&exd=Use%20of%20uninitialized%20variable.%20%28runtime%20error%20%26he9%29%20in%20pkg%3A%2Fsource%2FgoogleAnalytics.brs%28213%29&av=1.0.2&exf=0&aid=dev&cid=test_client_id&aiid=1234X&t=exception&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function
...
Function TestCase__GoogleAnalytics_customHitParams() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString, "v=1&av=1.0.2&aid=dev&cid=test_client_id&aiid=1234X&cd1=7.5.1&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function
...
Function TestCase__GoogleAnalytics_customHitParamsOverrideSessionParams() As String
  ...
  hitString = GoogleAnalyticsTesSuite__HandleMockGAServerEvent(m.mockGA)
  return m.AssertEqual(hitString, "v=1&av=1.0.2&aid=dev&cid=client_id_override&aiid=1234X&an=roku-gamp&tid=test-tracking-id-1&z=1")
End Function
